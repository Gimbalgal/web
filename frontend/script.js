...
// schedule and conatct forms

// Generic form handler with feedback
function handleFormSubmit(formId, messageId, endpoint) {
  ...
  function showMessage(message, isSuccess = true) {
    ...
    if (isSuccess) {
      messageElement.style.backgroundColor = "#d4edda"; // green
      messageElement.style.color = "#155724";
    } else {
      messageElement.style.backgroundColor = "#f8d7da"; // red
